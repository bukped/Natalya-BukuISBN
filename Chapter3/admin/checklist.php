    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
                <div class="row">
                    <div class="col-md-10">
                        <h5 class="card-header">List Pengajuan Pinjaman</h5>
                        ...
                        <tbody class="table-border-bottom-0">
                            ...
                            foreach ($u_all as $r) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a style="color: white;" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#acc<?= $r->id_pinjaman; ?>">Acc</a>
                                        <a style="color: white;" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#tolak<?= $r->id_pinjaman; ?>">Tolak</a>
                                    </td>
                                </tr>
                                <!-- MODAL EDIT -->
